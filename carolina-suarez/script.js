document.getElementById('lead-form').addEventListener('submit', function (e) {
    ...
    const texto = `Hola Carolina! Te contacto desde tu web. Mi nombre es ${nombre}, mi teléfono es ${telefono} y quisiera consultar sobre: ${servicio}.`;
    const url = `https://wa.link/wjturb`;
